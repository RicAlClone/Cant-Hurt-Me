...
const Calloused = function(props) {
  ...
  return (
    ...
    <Accordion>
      ...
      <Accordion.Body>
        <p>
          This challenge is intended to toughen and build a callus over your mind. To do this we must get out of our comfort zone and do things everyday that we dont want to do,that will improve your life. Even if its as simple as making your bed, or washing your dishes. The key to this is doing it every day. Once this becomes normal and comfortable,its time to add more. For example if running 1 mile everyday becomes comfortable, increase it by 1.5 miles everyday.The goal is to keep callousing the mind.</p>
      </Accordion.Body>
    </Accordion>
        ...
        ? <form>
            <div className="all-main-containers">
              <div className="inner-container" style={{
                ...
                <InputArea addItems={addItems} message={message}/>
