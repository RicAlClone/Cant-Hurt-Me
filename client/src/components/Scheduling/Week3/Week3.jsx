...
//I create every day to be an object like skeleton
  ...
  function authCheck(){
    console.log('running authCheck, week3');
    AuthService.isAuthenticated().then(data=>{
      if(!data.isAuthenticated){
        console.log('authCheck is reading, not authenticated, week 3')
  ...
  useEffect(()=>{
    ...
    const signal = controller.signal;
      ...
      return ()=>{
        ...
        // AuthService.isAuthenticated().then(data=>{
        //   if(!data.isAuthenticated){
        //     console.log('authCheck, week 3, is reading, not authenticated')
        //     setIsAuthenticated(false);
        //     setUser({username:""});
        //   }
        // })
...
setEditButtonStyle('btn btn-info');
  ...
  return(
    <div className="week-padding">
      ...
      <div id="week3" className="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
